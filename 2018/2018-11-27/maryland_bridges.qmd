...
maryland_bridges  |> 
  ...
  geom_line() +
  expand_limits(y = 0) +
  labs(y = "# of bridges in Baltimore build this decade")
...
The County Highway Agency consistently has the most bridges rates as "Good" from before 1970. State Toll Authority is under performing in bridges built in the 1990s.
